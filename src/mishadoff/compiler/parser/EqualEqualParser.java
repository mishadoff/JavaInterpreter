...
import mishadoff.compiler.tokens.EqualEqualToken;
import mishadoff.compiler.tokens.Token;

public class EqualEqualParser implements TokenParser{
	...
	public Token parseToken(String source, int fromIndex) {
		...
		Token token = new EqualEqualToken(fromIndex, fromIndex+mText.length(), mText);
		return token;
	}
}
