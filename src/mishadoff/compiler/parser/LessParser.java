...
import mishadoff.compiler.tokens.LessToken;
import mishadoff.compiler.tokens.Token;

public class LessParser implements TokenParser{
	...
	public Token parseToken(String source, int fromIndex) {
		...
		Token token = new LessToken(fromIndex, fromIndex+mText.length(), mText);
		return token;
	}
}
