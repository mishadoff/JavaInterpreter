...
import mishadoff.compiler.tokens.GreaterToken;
import mishadoff.compiler.tokens.Token;

public class GreaterParser implements TokenParser{
	...
	public Token parseToken(String source, int fromIndex) {
		...
		Token token = new GreaterToken(fromIndex, fromIndex+mText.length(), mText);
		return token;
	}
}
