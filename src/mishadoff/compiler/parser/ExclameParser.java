...
import mishadoff.compiler.tokens.ExclameToken;
import mishadoff.compiler.tokens.Token;

public class ExclameParser implements TokenParser{
	...
	public Token parseToken(String source, int fromIndex) {
		...
		Token token = new ExclameToken(fromIndex, fromIndex+mText.length(), mText);
		return token;
	}
}
